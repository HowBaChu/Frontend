...
import PROFILE_PURPLE from "../assets/imgs/default-profile-img-purple.png";
import FIRE_WHITE from "../assets/imgs/fire-white.png";
import HEART from "../assets/imgs/empty_heart_icon.png";
...
const OpinionBox = styled.div`
  display: flex;
  flex-direction: ${({ isMine, className }) =>
